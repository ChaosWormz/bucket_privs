...
minetest.register_privilege("spill", {"Can empty buckets", give_to_singleplayer = false})
...
local function check_protection(pos, name, text)
	...
	if not minetest.get_player_privs(name).spill then
		minetest.log("action", (name ~= "" and name or "A mod")
			.. " tried to " .. text
			.. " at position "
			.. minetest.pos_to_string(pos)
			.. " without spill")
		minetest.chat_send_player(name, "You'll need spill privs for that.")
		return true
	end
	return false
end
